...
public class EmpreendimentoRequestDTO {
    ...
    @Size(max = 100, message = "O nome do empreendimento deve ter no máximo 100 caracteres")
    private String nomeEmpreendimento;

    @NotBlank(message = "O nome do empreendedor não pode estar em branco")
    @Size(max = 100, message = "O nome do empreendedor deve ter no máximo 100 caracteres")
