...
public class EmpreendimentoRequestDTO {
    ...
    @Size(max = 100, message = "O nome do empreendimento não pode ter mais de 100 caracteres")
    private String nomeEmpreendimento;

    @NotBlank(message = "O nome do empreendedor não pode estar em branco")
    @Size(max = 100, message = "O nome do empreendedor não pode ter mais de 100 caracteres")
